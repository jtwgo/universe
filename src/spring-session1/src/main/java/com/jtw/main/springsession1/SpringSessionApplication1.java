package com.jtw.main.springsession1;
...
@RestController
public class SpringSessionApplication1 {

    public static void main(String[] args) {
        SpringApplication.run(SpringSessionApplication1.class, args);
    }
    ...
    public String setSession(HttpServletRequest request, String key,String value)
    {
        ...
        return "server-port:"+port+" success,id:"+id;
